...
namespace SiteMVC.Controllers
{
    ...
    public class EmprestimoController : Controller
    {
        ...
        {
            var itemExistente = _context.Items.FirstOrDefault(i =>
            i.Nome == emprestimo.Item &&
            i.Tipo == emprestimo.TipoItem &&
            i.Id == emprestimo.IdItem);

            if (itemExistente != null)
            {
                // A combinação existe na tabela items
